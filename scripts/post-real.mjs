...
const md = readFileSync("fixtures/real.md", "utf8");
let pageNumbers;
if (existsSync("out/pagenums.json")) {
  pageNumbers = JSON.parse(readFileSync("out/pagenums.json", "utf8"));
  console.log("using measured pageNumbers:", Object.keys(pageNumbers).length, "entries");
}
...
if (res.ok) {
  ...
  console.log("saved out/real.pdf", buf.length, "bytes");
} else {
